...
namespace EfDbFirstDemo.DataModel
{
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Department", "EmployeeExercise");
            ...
            {
                entity.ToTable("EmpDetails", "EmployeeExercise");
                ...
                entity.Property(e => e.AddressTwo).HasMaxLength(100);
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_DetailsToEmployee");
            });
            ...
            {
                entity.ToTable("Employee", "EmployeeExercise");
                ...
                entity.HasOne(d => d.Dept)
                    ...
                    .HasConstraintName("FK_EmployeeToDepart");
            });
